 ...
 */
public class ValidationManagerIncludingTest {
    @Test
    @DisplayName("Валидация правильного запроса.")
    void testChainAllCorrect() throws IOException {
        ValidationManager validationManager = new ValidationManager("/home/vodobryshkin/progs/proj/IdeaProjects/coordinates-validation-web-labs/src/main/resources/validation.json");
        String x = "2";
        String y = "2";
        String r = "2";
